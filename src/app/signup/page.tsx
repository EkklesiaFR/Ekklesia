      ...
      <div className="flex flex-col items-center justify-center py-12 space-y-10 animate-in fade-in duration-700">
        <header className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground max-w-sm mx-auto">
            Créez votre compte pour soumettre des projets et participer aux votes.
          </p>
        </header>
        ...
        <div className="w-full max-w-sm space-y-8">
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <Button
              ...
              className="w-full h-12 rounded-none font-bold uppercase tracking-widest text-xs gap-2"
            >
