      ...
      {!activeAssembly ? (
        <section className="border border-border p-12 bg-secondary/5 text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">Il n’y a pas de vote en cours. Revenez prochainement pour participer.</p>
          </div>
        </section>
      ) : (
        <>
        ...
        >
          <div className="h-full border border-border p-8 bg-white hover:border-black transition-all space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">Exprimez vos préférences pour les projets de la session.</p>
            </div>
          </div>
        </Link>
        <Link href="/projects" className="group h-full">
          <div className="h-full border border-border p-8 bg-white hover:border-black transition-all space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">Consultez l'ensemble des initiatives citoyennes.</p>
            </div>
          </div>
        </Link>
        {isAdmin ? (
          ...
          <Link href="/account" className="group h-full">
            <div className="h-full border border-border p-8 bg-white hover:border-black transition-all space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Gérez vos informations de membre actif.</p>
              </div>
            </div>
          </Link>
        )}
